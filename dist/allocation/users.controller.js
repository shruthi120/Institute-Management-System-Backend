...
let UsersController = class UsersController {
    ...
    async get_appointment_by_date(req, res) {
        const response = await this.usersService.get_createddate_and_role(req.query);
        console.log("iam query checker", req.query);
        return res.status(common_1.HttpStatus.OK).json({
            message: 'List of users in given date',
            user: response,
        });
    }
};
...
__decorate([
    ...
    __metadata("design:paramtypes", [Object, Object]),
    __metadata("design:returntype", Promise)
], UsersController.prototype, "get_appointment_by_date", null);
