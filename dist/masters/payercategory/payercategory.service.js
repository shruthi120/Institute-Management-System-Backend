...
exports.PayercategoryService = void 0;
const common_1 = require("@nestjs/common");
const mongoose_1 = require("@nestjs/mongoose");
const mongoose_2 = require("mongoose");
const payercategory_schema_1 = require("../../schemas/payercategory.schema");
let PayercategoryService = class PayercategoryService {
    constructor(payercategoryModel) {
    ...
    async insert_categoryBulk(exceldata, name) {
        let arrayToInsertinpayercategory = [];
        for (let row of exceldata) {
            const forcategory = {
                Category_Name: row.Category_Name,
            };
            arrayToInsertinpayercategory.push(forcategory);
        }
        await this.payercategoryModel.insertMany(arrayToInsertinpayercategory);
    }
    async getpayercategoryname(Category_Name) {
        const payercategory = await this.payercategoryModel.find({
...
PayercategoryService = __decorate([
    common_1.Injectable(),
    __param(0, mongoose_1.InjectModel("Payercategory")),
    __metadata("design:paramtypes", [mongoose_2.Model])
], PayercategoryService);
exports.PayercategoryService = PayercategoryService;
//# sourceMappingURL=payercategory.service.js.map