...
], Role.prototype, "management", void 0);
__decorate([
    mongoose_1.Prop({ default: false }),
    __metadata("design:type", Boolean)
], Role.prototype, "transaction", void 0);
__decorate([
    mongoose_1.Prop({ default: false }),
    __metadata("design:type", Boolean)
...
__decorate([
    mongoose_1.Prop({ default: false }),
    __metadata("design:type", Boolean)
], Role.prototype, "ai_bot", void 0);
__decorate([
    mongoose_1.Prop({ default: false }),
    __metadata("design:type", Boolean)
], Role.prototype, "performance", void 0);
__decorate([
    mongoose_1.Prop({ default: false }),
    __metadata("design:type", Boolean)
], Role.prototype, "action", void 0);
__decorate([
    mongoose_1.Prop({ default: false }),
    __metadata("design:type", Boolean)
...
__decorate([
    mongoose_1.Prop({ default: false }),
    __metadata("design:type", Boolean)
], Role.prototype, "configure", void 0);
__decorate([
    mongoose_1.Prop({ default: false }),
    __metadata("design:type", Boolean)
...
__decorate([
    mongoose_1.Prop({ default: false }),
    __metadata("design:type", Boolean)
], Role.prototype, "allocation", void 0);
Role = __decorate([
    mongoose_1.Schema()
], Role);
exports.Role = Role;
